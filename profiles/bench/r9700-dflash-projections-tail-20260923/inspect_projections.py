"""Check the eight new projection kernels and exact retained instruction streams."""
import re
import subprocess
...
old_receipt, old = inspect(ROOT/'profiles/bench/r9700-a8-bound-dflash-20260923/final-bin/bench', 'projection-baseline')
...
added = {(n,k,t) for n,k in [(7168,5120),(6144,5120),(1280,5120),(5120,4096)] for t in [5,6]}
