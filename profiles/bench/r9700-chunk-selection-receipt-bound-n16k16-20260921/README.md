...
Current production builds on the R9700, C1, ordinary prefill. Compare the three existing N16
...
```bash
bash profiles/bench/r9700-chunk-selection-receipt-bound-n16k16-20260921/commands.sh preflight
bash profiles/bench/r9700-chunk-selection-receipt-bound-n16k16-20260921/commands.sh freeze
bash profiles/bench/r9700-chunk-selection-receipt-bound-n16k16-20260921/commands.sh prepare
bash profiles/bench/r9700-chunk-selection-receipt-bound-n16k16-20260921/commands.sh screens
bash profiles/bench/r9700-chunk-selection-receipt-bound-n16k16-20260921/commands.sh finalists
bash profiles/bench/r9700-chunk-selection-receipt-bound-n16k16-20260921/commands.sh select
```
...
`profiles/bench/prefill-chunk-selection-receipt-bound-n16k16-20260921.json` only after the
