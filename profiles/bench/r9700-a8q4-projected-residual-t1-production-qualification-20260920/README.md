# Projected residual T1 production qualification
...
```bash
bash profiles/bench/r9700-a8q4-projected-residual-t1-production-qualification-20260920/commands.sh --preflight
bash profiles/bench/r9700-a8q4-projected-residual-t1-production-qualification-20260920/commands.sh --measure
```
