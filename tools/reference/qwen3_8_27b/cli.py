"""Command-line implementation diagnostic for the Qwen3.8-27B R9700 candidate."""
...
from tools.reference.qwen3.common.sampling import Sampler, SamplingConfig
from tools.reference.qwen3.common.tap import FileTap
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--weights", required=True, help="Qwen3.8-27B R9700 candidate artifact")
    ...
    with RefModel(
        ...
        if tap is not None:
            tap.close(
                ...
                kv_cache="fp8-e4m3fn-k/int4-g16-v/fp16-scale",
                prefill_chunk=args.prefill_chunk,
                mtp_draft_tokens=args.mtp_draft_tokens,
                draft_head=args.draft_head,
