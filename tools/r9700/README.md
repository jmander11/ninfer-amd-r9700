...
all selected T2..6 and T10/12/15/18/20/24 widths. `--projection-only` covers
N7168/K5120, N6144/K5120, N1280/K5120 and N5120/K4096 at their selected widths.
`--concurrent-only` covers the48 non-MLP projection cells at T10/12/15/18/20/24,
...
six heads. At visible context>=12288, PV uses FP16 WMMA with16 query rows,
128 value features and six waves per block, with16 key splits (32 from context32768),
