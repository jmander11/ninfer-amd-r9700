"""Family storage vocabulary used by the exact Qwen3 artifact target.
...
LAYOUT_NAMES = (CONTIGUOUS_LAYOUT, ROW_SPLIT_LAYOUT, Q4_LAYOUT)
...
def build_vision_specs(text_width: int) -> tuple[TensorSpec, ...]:
    """Build the Qwen3.8 Vision inventory for the target text width."""
