...
#ifndef NINFER_R9700_PROJECTED_RESIDUAL_T1_CANDIDATE
#define NINFER_R9700_PROJECTED_RESIDUAL_T1_CANDIDATE 0
#endif
static_assert(NINFER_R9700_PROJECTED_RESIDUAL_T1_CANDIDATE == 0 ||
                  NINFER_R9700_PROJECTED_RESIDUAL_T1_CANDIDATE == 1,
              "R9700 projected-residual T1 candidate selector must be zero or one");
inline constexpr bool kProjectedResidualT1CandidateEnabled =
    NINFER_R9700_PROJECTED_RESIDUAL_T1_CANDIDATE == 1;
