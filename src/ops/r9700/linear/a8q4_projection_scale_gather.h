...
// restricted to T5/T6 and N5120/K6144, N12288/K5120, N4096/K5120.
// No allocation or persistent-weight transformation.
[[nodiscard]] hipError_t a8q4_projection_scale_gather_candidate(
    const A8Q4G64CandidateArgs& args, hipStream_t stream) noexcept;
namespace detail {
[[nodiscard]] constexpr bool use_a8q4_projection_scale_gather(
    ...
    return (tokens == 5 || tokens == 6) && columns == padded_columns &&
        ((rows == 5120 && columns == 6144) ||
         ((rows == 12288 || rows == 4096) && columns == 5120));
}
...
[[nodiscard]] hipError_t launch_a8q4_projection_scale_gather(
