...
// >= kChunkedMinimumWidth (one masked chunk already beats the sequential kernel at T16). One workgroup per value head walks 64-token chunks: per chunk it forms
...
inline constexpr std::int32_t kChunkedMinimumWidth = 16;
