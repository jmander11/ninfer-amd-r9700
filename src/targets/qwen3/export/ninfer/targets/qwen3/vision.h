...
struct VisionWeightPlan {
    artifact::ObjectHandle object;
    artifact::NumericFormat format = artifact::NumericFormat::W8G32_F16S;
};
...
struct VisionBackbonePlan {
    VisionWeightPlan patch_embedding;
